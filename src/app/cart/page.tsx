      ...
      {items.length === 0 ? (
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div key={it.id} className="border rounded-xl p-4 flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <button
                      type="button"
                      className="px-3 py-1 border rounded-lg bg-blue-600 hover:bg-blue-700 text-white"
                    ...
                    <input
                      className="w-16 text-center border rounded-lg py-1  bg-blue-600 text-white [&::-webkit-inner-spin-button]:appearance-none"
                      type="number"
                      min={1}
                      value={it.quantity}
                      onChange={(e) => {
          ...
          <aside className="border rounded-xl p-4 h-fit">
            ...
            <Link
              href="/checkout"
              className="mt-4 inline-flex w-full justify-center px-4 py-2 rounded-lg border hover:opacity-90 bg-blue-600 hover:bg-blue-700 text-white"
            >
              Go to Checkout
            </Link>
          </aside>
